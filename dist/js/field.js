...
Nova.booting(function (app, store) {
  app.component('index-bulk-upload-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-bulk-upload-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-bulk-upload-field', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
    ...
    uploadAttachment: function uploadAttachment(file, _ref) {
      ...
      Nova.request().post("/nova-api/".concat(this.resourceName, "/field-attachment/").concat(this.fieldAttribute), data, {
        ...
        if (error.response.status == 422) {
          var validationErrors = new Object(function webpackMissingModule() { var e = new Error("Cannot find module 'form-backend-validation'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(error.response.data.errors);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    resetErrors: function resetErrors() {
      this.validationErrors = new Object(function webpackMissingModule() { var e = new Error("Cannot find module 'form-backend-validation'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    }
  }
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  created: function created() {
    var _this = this;
    this.removeOnNavigationChangesEvent = Object(function webpackMissingModule() { var e = new Error("Cannot find module '@inertiajs/inertia'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).on('before', function (event) {
  ...
  methods: _objectSpread(_objectSpread({}, Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vuex'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(['allowLeavingForm', 'preventLeavingForm', 'triggerPushState', 'resetPushState'])), {}, {
    ...
    handlePreventFormAbandonmentOnInertia: function handlePreventFormAbandonmentOnInertia(event) {
      ...
      this.handlePreventFormAbandonment(function () {
        ...
        Object(function webpackMissingModule() { var e = new Error("Cannot find module '@inertiajs/inertia'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).ignoreHistoryState = true;
        event.preventDefault();
        event.returnValue = '';
        _this3.removeOnNavigationChangesEvent = Object(function webpackMissingModule() { var e = new Error("Cannot find module '@inertiajs/inertia'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).on('before', function (event) {
    ...
    handleProceedingToPreviousPage: function handleProceedingToPreviousPage() {
      ...
      Object(function webpackMissingModule() { var e = new Error("Cannot find module '@inertiajs/inertia'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).ignoreHistoryState = false;
      this.removeOnBeforeUnloadEvent();
...
/* harmony import */ var _Users_jamie_Development_nova_dam_nova_components_BulkUploadField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_jamie_Development_nova_dam_nova_components_BulkUploadField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcreode_bulk_upload_field"] = self["webpackChunkcreode_bulk_upload_field"] || [];
